...
|-------|---------|--------------|------|-------|
| **CEO Agent** | Synthesize everything into daily priorities | Board briefing, roadmap | Goal pace, focus quality | ▶ Partial (Ask CARVIS) |
...
**Phase 1 — The Executive Layer** _(next)_
- **CEO Daily Briefing** — the "morning board meeting" generated by the live brain from
  CarVis's real data (this month's pace, prospects, habit streak): Top Priorities, Quick
  Wins, Sales/Inventory/Lead/Referral focus, Blind spots. _Flagship of the charter._
- **Follow-up Engine** — prospect aging, "went quiet N days," daily call/text list with SLA.
...
_Next: Phase 1 — Executive Layer. First build recommended: **CEO Daily Briefing**._
