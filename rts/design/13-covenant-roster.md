...
> Data: [`../data/units/covenant.json`](../data/units/covenant.json) · validated (0 failures / 0 warnings, all 10 threats). Compare with [Directorate](12-directorate-roster.md).
